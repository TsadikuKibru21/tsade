    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('R_name', models.CharField(default='Student', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('Departmnet', models.CharField(blank=True, max_length=200, null=True)),
                ('Year_of_Student', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Role', models.ForeignKey(blank=True, default='student', null=True, on_delete=django.db.models.deletion.CASCADE, to='account.role')),
